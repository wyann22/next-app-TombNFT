export default function Footer() {
  return (
    <>
      <div className="my-32 grid text-center items-center justify-center lg:mb-0 lg:w-full lg:grid-cols-4 lg:text-left">
        <a
          href="/market"
      ...
      <footer className="footer items-center p-4 bg-black text-neutral-content mt-20">
